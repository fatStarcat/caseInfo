<template>
  <div id="caseAllot" class="main-content" ref="main">
...
<script>
  ...
  export default {
    ...
    components: {DatePicker,RadioGroup,Radio,Input,Table,Page,lookModal},
    data() {
      return {
        ...
        sendInfo: {//已发送信息
          ...
          caseName: '张三纵火案',//案件名称
          content: '我院受理的XX案件已分配给XX检察官',//通知内容
        },
        total: 0,//表格总数据
        pageNum: 1,//表格当前页
        pageSize: 20,//当前页大小
    ...
    methods: {
      ...
      getList() {
        let _this = this;
        let url =  webApi.getCaseAllotNoticeList;
        this.loading = true;
        this.axios.get(url)
          .then(function(res){
